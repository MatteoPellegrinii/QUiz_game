...
function GameBoard({ answers, questions }) { // Imposta lo stato iniziale del timer (5 minuti = 300 secondi)
  ...
  let [currentTeam, setCurrentTeam] = useState('red');
  ...
  return (
    <div className={`game game-container ${gameOver ? 'game-over' : ''}`}>
      ...
      <div className="timer">{formatTime()}</div>
        <ScoreBoard team1Score={team1Score} team2Score={team2Score} team3Score={team3Score} currentTeam={currentTeam} setCurrentTeam={setCurrentTeam}  />
      </div>
